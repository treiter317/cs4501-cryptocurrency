...
contracts = {
	...
	# address, above.
	'dao': '0x551c4834313457Eff903172aC08C3AAb09Dc3e4D',
...
other = {
	...
	'dao_vote_txn': "0x57ce363c4047d92aee10c890cd28fb3b1716e942685175c96edad596bb1276a2",

	# What is the 8 hex digit suffix for your dao_XXXXXXXX.html file?  Just
	# the 8 hex digits, please.
	'dao.html_suffix': "11aac5f4",
...
comments = {
	...
	'suggestions': "Potentially give more either links or tutorials on how to interact with web 3 libraries. Most of my time spent on this assigment was understanding web3 by analyzing how your Auction.php site worked.",
